...
lorenz_state2$name <- factor(lorenz_state2$name, levels = legend_label)
...
fish1_state2$name <- factor(fish1_state2$name, levels = legend_label)
...
fish2_state2$name <- factor(fish2_state2$name, levels = legend_label)
